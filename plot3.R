## ----------------------------------------------------------------------------------------------------------------
##
## This script plots the three series of "sub metering" data for the two day period from 2007/02/01 to 2007/02/02. 
...
# Plot a time series to the PDF device for energy sub metering
...
#Finally, turn off the graphics device
dev.off()
