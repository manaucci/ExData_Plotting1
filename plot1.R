## ----------------------------------------------------------------------------------------------------------
##
## This script plots the "Global Active Power"frequency data for the two day period from 2007/02/01 to 2007/02/02. 
...
# pdf(file="plot1.pdf", width=6.4, height = 6.4)

#then call hist function with the paramters and plot to the grqaphics device
hist(subhsdata$Global_active_power, col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)", ylab = "Frequency" )
